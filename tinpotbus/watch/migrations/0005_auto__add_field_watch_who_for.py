...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Watch.who_for'
        db.add_column(u'watch_watch', 'who_for',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Watch.who_for'
        db.delete_column(u'watch_watch', 'who_for')
    ...
    models = {
        u'watch.service': {
            ...
            'last_monitored_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
